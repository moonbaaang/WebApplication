...
<head>
	...
	<script src="<%=request.getContextPath()%>/resources/js/test.js" type="text/javascript">
	</script>
...
<!--                 <a href="#">LOGIN</a> | -->
                <a href="#">JOIN</a> | 
                <form>ID <input class="login" id="id"> PW <input type="password" class="login" id="pw"> 
                <button id="login_btn" onClick="btn();">LOGIN</button></form>
            </div>
